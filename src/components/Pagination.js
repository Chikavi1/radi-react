...
export const Pagination = ({ postsPerPage,totalPosts,paginate }) => {
    ...
    <div className="flex text-gray-700">
        <div  onClick={ disminuir }  className="h-12 w-12 mr-1 flex justify-center items-center rounded-full bg-gray-200 cursor-pointer">
        ...
        <div className="flex h-12 font-medium rounded-full bg-gray-200">
            <div className="w-12 h-12  flex justify-center items-center cursor-pointer leading-5 transition duration-150 ease-in rounded-full bg-teal-600 text-purple-600">{indice}</div>
        </div>
        <div   onClick={ aumentar } className="h-12 w-12 ml-1 flex justify-center items-center rounded-full bg-gray-200 cursor-pointer">
